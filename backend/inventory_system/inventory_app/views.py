...
#         y = height - 140
#         p.drawString(50, y, f"Total Sales: ${report.total_sales:.2f}")
#         p.drawString(50, y - 20, f"Total Purchases: ${report.total_purchases:.2f}")
#         p.drawString(50, y - 40, f"Total Expenses: ${report.total_expenses:.2f}")
#         p.drawString(50, y - 60, f"Net Profit: ${report.net_profit:.2f}")
